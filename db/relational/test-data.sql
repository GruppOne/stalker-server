...
INSERT INTO `organizations` (`name`, `description`, `ldap_conf`, `created_date`, `last_modified_date`) VALUES
...
INSERT INTO `place` (`organization_id`, `name`, `position`) VALUES
(1, 'Aule Luzzati', PolygonFromText(@g)),
(1, 'Complesso Paolotti', PolygonFromText(@h)),
(2, 'Torre Archimede', PolygonFromText(@j));
...
INSERT INTO `userdata` (`user_id`, `firstname`, `lastname`, `birth_date`, `created_date`, `last_modified_date`) VALUES
