...
@WritingConverter
public class OrganizationRoleWriteConverter implements Converter<OrganizationRoleDao, OutboundRow> {

  public OutboundRow convert(final OrganizationRoleDao dao) {
