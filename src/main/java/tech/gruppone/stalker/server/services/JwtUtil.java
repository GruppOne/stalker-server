...
public class JwtUtil{
   ...
   public String createToken(Long id, String username, Map <String, List<UserRoleDto>> claims){
   ...
   public List<UserRoleDto> parseUserRoles(String token) throws IOException {
     ...
     List<UserRoleDto> list = mapper.readValue(str, new TypeReference<List<UserRoleDto>>() { });
     return list;
