...
@WritingConverter
public class OrganizationRoleDaoWriteConverter
    implements Converter<OrganizationRoleDao, OutboundRow> {

  public OutboundRow convert(final OrganizationRoleDao organizationRoleDao) {
