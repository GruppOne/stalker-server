...
public interface ConnectedRepository extends ReactiveCrudRepository<ConnectedOrganization, Long> {

  @Query("select o.id, o.name, o.description from Connections c, Organizations o where c.organizationId = o.id and c.userId = :id")
  public Flux<ConnectedOrganization> findOrganizationListById(Long id);
}
